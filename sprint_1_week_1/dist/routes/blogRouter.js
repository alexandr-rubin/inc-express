...
exports.blogsRouter.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    return res.status(200).send(yield blogsService_1.blogService.getBlogs(req));
}));
...
exports.blogsRouter.get('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const blog = yield blogsService_1.blogService.getBlogById(req.params.id);
    if (blog) {
...
exports.blogsRouter.get('/:blogId/posts', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const posts = yield blogsService_1.blogService.getPostsForSpecifiedBlog(req.params.blogId, req);
    if (posts === null) {
        return res.status(404).send('Blog not found');
    }
