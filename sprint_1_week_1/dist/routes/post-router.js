...
exports.postsRouter.get('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const blog = yield post_respository_1.postRepository.getPostById(new mongodb_1.ObjectId(req.params.id));
    if (blog) {
...
exports.postsRouter.put('/:id', Post_1.validatePost, validation_errors_handler_1.validationErrorsHandler, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const post = yield post_respository_1.postRepository.updatePostByid(new mongodb_1.ObjectId(req.params.id), req.body);
    if (post) {
...
exports.postsRouter.delete('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (yield post_respository_1.postRepository.deletePostById(new mongodb_1.ObjectId(req.params.id))) {
